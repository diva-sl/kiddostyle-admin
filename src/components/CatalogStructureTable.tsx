...
export const CatalogStructureTable: React.FC = () => {
  ...
  return (
    <div className="bg-white rounded-3xl border border-[#dfbec4]/30 shadow-sm overflow-hidden">
              ...
              >
                ...
                <td className="px-6 py-5">
                  <div className="flex flex-wrap gap-1.5 max-w-[240px]">
                    ...
                    {row.extraTags && (
                      <span className="px-2.5 py-0.5 bg-[#e2e7ff] text-[#131b2e] text-[9px] font-extrabold rounded-full select-none">
                        {row.extraTags}
                      </span>
                    )}
                  </div>
                ...
                <td className="px-6 py-5 text-right">
                  <div className="flex justify-end gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity">
                    <button className="p-1.5 hover:bg-[#f2f3ff] rounded-full text-[#584045]/70 hover:text-[#b31f56] transition-colors cursor-pointer">
                      <MdEdit className="w-4.5 h-4.5" />
                    </button>
                    <button className="p-1.5 hover:bg-[#f2f3ff] rounded-full text-[#584045]/70 hover:text-[#ba1a1a] transition-colors cursor-pointer">
                      <MdDelete className="w-4.5 h-4.5" />
                    </button>
                    <button className="p-1.5 hover:bg-[#f2f3ff] rounded-full text-[#584045]/70 cursor-pointer">
      ...
      <div className="px-6 py-4 border-t border-[#dfbec4]/20 flex justify-between items-center text-xs font-bold text-[#584045]/70 select-none">
        <span>Showing 4 of 14 categories</span>
        <div className="flex gap-1.5">
          <button
            className="p-2 rounded-lg border border-[#dfbec4]/25 hover:bg-[#faf8ff] disabled:opacity-30 cursor-not-allowed"
            disabled
          >
            <MdChevronLeft className="w-5 h-5" />
          </button>
          <button className="p-2 rounded-lg border border-[#dfbec4]/25 hover:bg-[#faf8ff] cursor-pointer">
