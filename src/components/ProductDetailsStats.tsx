...
export const ProductDetailsStats: React.FC<StatsProps> = ({ price }) => {
  const displaySales = price ? price * 124 : 4280.00;
    ...
    <div className="space-y-4">
      <div className="bg-[#00a4ca] p-6 rounded-3xl shadow-sm text-white relative overflow-hidden flex flex-col justify-between min-h-[140px]">
        <div>
          ...
          <h3 className="text-2xl font-extrabold mt-1">${displaySales.toFixed(2)}</h3>
        </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-[#f2f3ff] p-5 rounded-2xl border border-[#dfbec4]/30">
          ...
          <h4 className="text-lg font-extrabold text-[#131b2e] mt-1.5">1,842</h4>
          <span className="text-[10px] text-[#584045]/80 font-bold block mt-1">Avg 61/day</span>
        </div>
        ...
        <div className="bg-[#f2f3ff] p-5 rounded-2xl border border-[#dfbec4]/30">
          ...
          <span className="text-[10px] text-[#006780] font-extrabold block mt-1">Above average</span>
        </div>
      </div>
    </div>
  );
