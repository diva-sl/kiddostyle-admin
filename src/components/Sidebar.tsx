...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-64 z-40 overflow-y-auto bg-[#f2f3ff] border-r border-[#dfbec4]/30 shadow-sm flex flex-col justify-between premium-scroll">
        ...
        <nav className="px-4 pb-6 space-y-1">
          ...
          <SidebarItem
            ...
            active={
              ...
              !currentPath.includes("/customers/analytics")
            }
          />
          <SidebarItem
          ...
          <div className="pt-4 pb-1 px-4">
            <span className="text-[10px] text-[#584045]/60 font-bold uppercase tracking-widest">
              Content
            </span>
          </div>
      ...
      {/* Footer Support Promo Card & Logout Button */}
      <div className="p-6 shrink-0 flex flex-col gap-3">
        <button
          onClick={handleLogout}
          className="w-full py-2.5 bg-white border border-[#dfbec4] text-[#ba1a1a] rounded-xl font-bold text-xs hover:bg-[#ffdad6]/20 transition-all cursor-pointer text-center select-none"
        >
          Log Out Session
        </button>
