  ...
  return (
    <div className="space-y-8 select-none">
      ...
      <section className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <button className="flex items-center gap-1.5 bg-[#b31f56] text-white px-6 py-3 rounded-full font-bold text-xs shadow-lg hover:shadow-[#b31f56]/20 hover:scale-[1.02] active:scale-95 transition-all cursor-pointer">
